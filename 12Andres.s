...
loop:
    ...
    cmp w3, w4                        // Comparar el valor actual con el máximo
    csel w3, w3, w4, gt               // Si w4 > w3, actualizar w3 con w4
...
end_loop:
    ...
    mov w1, w3                        // Mover el máximo encontrado a w1
    ...
    .data
array:      .word 19, 32, 57, 11, 43, 75, 26, 61, 90, 6    // Arreglo con valores diferentes
arr_len:    .word 10                                      // Longitud del arreglo
msg_result: .asciz "El valor máximo encontrado es: %d\n"   // Mensaje para imprimir
